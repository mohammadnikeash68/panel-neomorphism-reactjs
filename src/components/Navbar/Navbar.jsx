              ...
              <div className="col-xl-2 col-lg-4 col-md-6 col-sm-12 sidebar-nav fixed-top shadow">
                ...
                <ul className="navbar-nav list-unstyled d-flex flex-column wrap-ul-sidebar">
                  ...
                  <ul className="navbar-nav list-unstyled d-flex flex-column">
                    <h6 className="mx-3 text-muted  d-block box-shadow1 text-center p-2">
                      فروشگاه
                    </h6>
                    <li className="nav-item mb-3">
                      <a
                      ...
                      >
                        <i className="fas fa-home"></i>
                        <span className="mx-3">مدیریت گروه محصول</span>
                      </a>
                    </li>
                    <li className="nav-item mb-3">
                      <a
                      ...
                      >
                        <i className="fas fa-home"></i>
                        <span className="mx-3">مدیریت  محصول</span>
                      </a>
                    </li>
                    <li className="nav-item mb-3">
                      <a
                      ...
                      >
                        <i className="fas fa-home"></i>
                        <span className="mx-3">مدیریت  برندها</span>
                      </a>
                    </li>
                    <li className="nav-item mb-3">
                      <a
                      ...
                      >
                        <i className="fas fa-home"></i>
                        <span className="mx-3">مدیریت  گارانتی ها</span>
                      </a>
                    </li>
                    <li className="nav-item mb-3">
                      <a
                      ...
                      >
                        <i className="fas fa-home"></i>
                        <span className="mx-3">مدیریت  رنگ ها</span>
                      </a>
                    </li>
                    <li className="nav-item mb-3">
                      <a
                      ...
                      >
                        <i className="fas fa-home"></i>
                        <span className="mx-3">مدیریت تخفیف ها</span>
                      </a>
                    </li>
                  </ul>
                  {/* end store heading */}
                  ...
                  <ul className="navbar-nav list-unstyled d-flex flex-column">
                    ...
                    <li className="nav-item mb-3">
                      ...
                      >
                        <i className="fas fa-home"></i>
                        <span className="mx-3">مدیریت سبدها</span>
                      </a>
                    </li>
                    <li className="nav-item mb-3">
                      <a
                      ...
                      >
                        <i className="fas fa-home"></i>
                        <span className="mx-3">مدیریت سفارشات</span>
                      </a>
                    </li>
                    <li className="nav-item mb-3">
                      <a
                      ...
                      >
                        <i className="fas fa-home"></i>
                        <span className="mx-3">مدیریت  نحوه ارسال</span>
                      </a>
                    </li>
                  ...
                  <ul className="navbar-nav list-unstyled d-flex flex-column">
                    ...
                    <li className="nav-item mb-3">
                      ...
                      >
                        <i className="fas fa-home"></i>
                        <span className="mx-3">مشاهده کاربران</span>
                      </a>
                    </li>
                    <li className="nav-item mb-3">
                      <a
                      ...
                      >
                        <i className="fas fa-home"></i>
                        <span className="mx-3">نقش ها</span>
                      </a>
                    </li>
                    <li className="nav-item mb-3">
                      <a
                      ...
                      >
                        <i className="fas fa-home"></i>
                        <span className="mx-3">مجوزها</span>
                      </a>
                    </li>
              ...
              <div className="border-vertical"></div>
                <div className="container-fluid">
                  <div className="row align-items-center">
                    <div className="col-sm-2">داشبورد</div>
                    <div className="col-sm-6">
                      <form className="d-flex">
                        <button className="btn  color-primary box-shadow1 rounded-circle me-2" type="button">
                          <i className="fas fa-search text-black"></i>
                        </button>
                        <input type="text" className="form-control box-shadow-inset" placeholder="جستجو..."/>
                      </form>
                    </div>
                    <div className="col-sm-4 text-end">
                    <span className="dropdown-center">
                      <a href="#" className="text-muted  box-shadow1 px-2 rounded-2 position-relative" data-bs-toggle="dropdown">
                      ...
                      <ul className="dropdown-menu box-shadow1 back-color-primary border-0 p-0">
                        <li><a href="#" className="dropdown-item">پیام یک</a>
                        <div class="border-horizontal"></div>
                        </li>
                        

                        <li><a href="#" className="dropdown-item">پیام دو</a>
                        <div class="border-horizontal"></div>
                        </li>
                        <li><a href="#" className="dropdown-item">پیام سه</a></li>
                      </ul>
                      </span>
                      <span className="dropdown-center">
                      <a href="#" className="text-muted ms-2 box-shadow1 px-2 rounded-2" data-bs-toggle="dropdown"><i className="fas fa-bars"></i></a>
                      <ul className="dropdown-menu box-shadow1 back-color-primary border-0 p-0">
                        <li><a href="#" className="dropdown-item">تنظیمات</a>
                        <div class="border-horizontal"></div>
                        </li>
                        <li><a href="#" className="dropdown-item">محمد نیک عیش</a>
                        </li>
                      </ul>
                      </span>
                    </div>
